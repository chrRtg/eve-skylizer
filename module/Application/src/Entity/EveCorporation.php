 ...
 * EveCorporation
 *
 * @ORM\Table(name="eve_corporation", indexes={@ORM\Index(name="k_ticker", columns={"ticker"}), @ORM\Index(name="k_name", columns={"corporation_name"}), @ORM\Index(name="k_alliance_id", columns={"alliance_id"})})
 * @ORM\Entity
 */
