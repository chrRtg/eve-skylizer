...
class CurrentUserPlugin extends AbstractPlugin
{
    ...
    {        
        ...
        if ($this->authService->hasIdentity()) {
            ...
            $this->user = $this->entityManager->getRepository(User::class)->findOneByEveUsername($this->authService->getIdentity());
            if ($this->user==null) {
                // Oops.. the identity presents in session, but there is no such user in database.
                // We throw an exception, because this is a possible security problem. 
                throw new \Exception('Not found user with such Eve-Name');
            }
